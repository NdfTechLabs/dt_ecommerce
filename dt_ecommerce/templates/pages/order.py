...
def get_context(context):
	...
	context.phone_number = get_order_phone_number(context.doc)
...
def get_order_phone_number(doc):
			"""Get phone number from the Sales Order billing or shipping address."""
